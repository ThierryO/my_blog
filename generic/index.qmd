...
Current plans are a review of the [PeerSonic bat detector](http://peersonic.co.uk/), some examples of how bat detector observations can be analysed and some questions that I get repeatedly while giving statistical consultancy to ecologists and other scientists.
...
Then use continuous integration using
[Wercker<!-- spell-check: ignore -->
](https://www.wercker.com) to render the site and deploy it to the website.
