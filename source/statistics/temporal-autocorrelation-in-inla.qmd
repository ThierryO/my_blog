...
date: "2018-03-05"
image: temporal-autocorrelation-in-inla_files/figure-html/fig-fixed-1.png
...
This blog post was inspired by a post on the [
R-Sig-Mixed<!-- spell-check: ignore -->
models](https://stat.ethz.ch/pipermail/r-sig-mixed-models/2018q1/026481.html) mailing list.
...
```{r}
#| label: fig-fitted
#| fig.cap: "Comparsion of the fitted values for `ID == 1` under the different
#| models"
p <- bind_rows(
...
```{r}
#| label: fig-rf
#| fig.cap: "Comparsion of the random effects of `Hour` under the different
#| models"
p <- bind_rows(
...
- `ou`
    - Stands for the
      Ornstein-Uhlenbeck<!-- spell-check: ignore -->
      process
...
```{r}
#| label: fig-rf2
#| fig.cap: "Comparsion of the random effects of `Timestamp` under the different
#| continuous time step models"
p <- bind_rows(
...
```{r}
#| label: fig-fixed2
#| fig.cap: "Comparison of the fixed effects of the different continuous time
#| step models"
bind_rows(
