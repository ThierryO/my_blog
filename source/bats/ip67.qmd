...
#| label: read-data
library(tidyverse)
observation <- read_csv("data/ip67.csv")
binwidth <- 2
...
```{r}
#| label: fig-length
#| fig-cap: !expr sprintf("Distribution of the number of recordings per %i minutes", binwidth) # nolint: line_length_linter.
#| fig-alt: !expr sprintf("Distribution of the number of recordings per %i minutes", binwidth) # nolint: line_length_linter.
ggplot(
  observation,
