...
- peak time, time shift Fourier ellipse
- peak frequency, frequency shift Fourier ellipse
- length semi-axes Fourier ellipses
- rotation first semi-axes Fourier ellipses

> - scale features?
> - how many Fourier components?
> - use multiple contours?
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/hUnRCxnydCc?rel=0&amp;showinfo=0" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
