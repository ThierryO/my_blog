...
In case you want to apply a change to someone else's branch. Create a new branch starting from the other's branch, add commits and create a pull request. Basically you use someone else's branch as the master branch.
