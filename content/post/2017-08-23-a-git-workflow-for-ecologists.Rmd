...
_What if I choose the wrong version?_**_ Don't panic, both versions remain in the history so you don't loose any. So you can create a new branch starting for the latest commit with the correct version and merge that branch.
