...
Here a a fex flowcharts that illustrate several components of the branching workflow with pull requests. Fig. \@ref(fig:prepare-repo) illustrates the steps you need when you want to start working on a project.
...
textellipse(c(0.5, 0.15), radx = 0.1, lab = "Start\nworking")
```
