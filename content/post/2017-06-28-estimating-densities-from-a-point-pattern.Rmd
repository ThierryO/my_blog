...
`leaflet` requires a predefined function with a colour pallet. We use `leaflet::colourNumeric()` to get a continuous pallet. Setting `stroke = FALSE` removes the borders of the polygon. `fillOpacity` sets the transparency of the polygons.
