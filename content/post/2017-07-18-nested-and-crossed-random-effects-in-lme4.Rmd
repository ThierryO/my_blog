...
People often get confused on how to code nested and crossed random effects in the [`lme4`](https://cran.rstudio.com/web/packages/lme4/) package.
...
Each numbering restarts at 1 when the higher level number changes.
...
Most of the `factory` and `product` combinations are present in the data and they are meaningfull.
Product 1 in factory 1 is the same product as product 1 in factory 2.
