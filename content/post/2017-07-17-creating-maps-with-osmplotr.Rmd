...
During [useR!2017](https://user2017.brussels/) I attend a talk by Mark Padgham titled [Maps are data, so why no plot data on a map](https://channel9.msdn.com/Events/useR-international-R-User-conferences/useR-International-R-User-2017-Conference/Maps-are-data-so-why-plot-data-on-a-map). In this blog post I will recreate the map from an earlier blogpost on [estimating density on a point pattern](../../06/estimating-densities-from-a-point-pattern).
