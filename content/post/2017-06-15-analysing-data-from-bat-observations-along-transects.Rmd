...
Next we check for each combination of track and grid cell wether we detected pipistrelles or not. Figure \@ref(fig:presence) displays the average presence over all tracks.
