...
m4_inlabru <- bru(comp_inlabru, data = goose, family = "nbinomial")
```
...
p_intercept <- plot(m4_inlabru) + 
  geom_vline(xintercept = 0, linetype = 2) +
  xlim(0, 4)
p_monthdec <- plot(m4_inlabru, "monthdec") + 
  geom_vline(xintercept = 0, linetype = 2) +
  xlim(0, 4)
p_monthjan <- plot(m4_inlabru, "monthjan") + 
  geom_vline(xintercept = 0, linetype = 2) +
  xlim(0, 4)
p_monthfeb <- plot(m4_inlabru, "monthfeb") + 
  geom_vline(xintercept = 0, linetype = 2) +
  xlim(0, 4)
