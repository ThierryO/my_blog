...
In this blog post I will recreate the map from an earlier blogpost on [estimating densities from a point pattern](../../statistics/point-pattern/index.html).
...
read.delim("../../statistics/point-pattern/data/points.txt", sep = " ") |>
