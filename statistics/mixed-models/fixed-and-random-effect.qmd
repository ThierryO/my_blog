...
#| echo: false
#| fig.cap: "Dummy dataset with a discrete variable. The line represents the true model."
...
#| fig.cap: "Fitted values (line) and observed values (points) from the lme4 model."
#| echo: false
#| warning: false
dataset %>%
  mutate(
...
#| fig.cap: "Fitted values from the fixed and random part of the `lme4` models. Points represent the true model."
#| echo: false
#| warning: false
dataset %>%
  select(X, mu) %>%
...
#| fig.cap: "Fitted values from the fixed and random part of the `INLA` models. Points represent the true model."
#| echo: false
#| warning: false
dataset2 %>%
  mutate(
...
#| echo: false
#| fig.cap: "Dummy dataset with a continuous variable. The line represents the true model."
ggplot(dataset, aes(x = X, y = Y)) + 
  geom_line(aes(y = mu)) +
  geom_point()
```
